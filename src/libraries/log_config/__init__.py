...
RUNTIME_LOG_PATH = './data/logs'
CUSTOM_LOG_PATH = './data/logs'

os.makedirs(CUSTOM_LOG_PATH,exist_ok=True)
...
# 设置日志文件的路径
c_logger = setup_logger('c_logger', f'{CUSTOM_LOG_PATH}/administrator.log')
...
def set_log_format():
    ...
    log_file_path = F"{RUNTIME_LOG_PATH}/runtime.log"
